...
knockout.register_tool("default:sword_stone", 0.2, 6, 150)
...
if minetest.get_modpath("lottweapons") ~= nil then
	...
	knockout.register_tool("lottweapons:wood_warhammer", 0.5, 4, 80)
	knockout.register_tool("lottweapons:stone_warhammer", 0.2, 4, 100)
